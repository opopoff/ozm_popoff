...
/**
 * Created by Danil on 09.06.2015.
 */
public class StaggeredGridViewWithCallback extends StaggeredGridView {
    ...
    public StaggeredGridViewWithCallback(Context context) {
        super(context);
        init();
    }

    public StaggeredGridViewWithCallback(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public StaggeredGridViewWithCallback(Context context, AttributeSet attrs, int defStyle) {
