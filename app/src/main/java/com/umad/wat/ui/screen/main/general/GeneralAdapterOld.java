...
public class GeneralAdapterOld extends ListBindableAdapter<ImageResponse> {
    ...
    public GeneralAdapterOld(Context context, @NonNull ActionListener actionListener, Picasso picasso) {
        super(context);
