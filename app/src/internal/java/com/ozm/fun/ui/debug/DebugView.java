...
import com.ozm.R;
import com.ozm.fun.OzomeApplication;
import com.ozm.fun.data.AnimationSpeed;
import com.ozm.fun.data.ApiEndpoint;
import com.ozm.fun.data.ApiEndpoints;
import com.ozm.fun.data.IsMockMode;
import com.ozm.fun.data.PicassoDebugging;
...
import com.ozm.fun.data.prefs.rating.DebugShowQualifier;
import com.ozm.fun.ui.misc.EnumAdapter;
import com.ozm.fun.util.DeviceManagerTools;
import com.ozm.fun.util.Keyboards;
